...
const ENGINE_COMPLETION_LABELS: string[] = [
  ...
  "runtime.forEachEntityDrawOrder",
  "runtime.getWorldTransform",
  "runtime.worldDeltaToLocal",
  "editor.playState",
  "editor.getSelectedEntityId",
  "editor.setSelectedEntity",
  "editor.pickEntityAt",
  "editorInput.mousePosition",
  "editorInput.mouseDown",
  "editorInput.mousePressed",
  "editorInput.mouseReleased",
  "defineProperties",
  "prop.number",
  "prop.integer",
  "prop.string",
